...
public class DiffMatchPatch {
  ...
  public String diff_prettyHtml(LinkedList<Diff> diffs) {
    ...
    for (Diff aDiff : diffs) {
      ...
      case INSERT:
        html.append("<span style=\"background:#21B56A;color:#fff;\">").append(text)
            .append("</span>");
        break;
      case DELETE:
        html.append("<del style=\"background:#bbb;color:#fff;\">").append(text)
            .append("</del>");
        break;
      case EQUAL:
  ...
  public String diff_String(String str1,String str2){
	 return  diff_prettyHtml(diff_main(str1,str2));
  }
  /**
